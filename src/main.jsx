...
function App(){
 ...
 const journey=hasCurrentHome(buyer)?[["Persoonlijk",s.personal,"profile"],[householdStepLabel(buyer),s.family,"profile"],["Werk",buyer.income?96:35,"profile"],[buyer.type==="private"?"Private woningpositie":"Eigen woning",s.home,"home"],["Financiën",s.financial,"profile"],["Documenten",s.docs,"documents"],["Adviesprofiel",s.advice,"advice"],["Marktinzicht",82,"market"],["Woningen",91,"matches"],["Paspoort",68,"share"]]:journeyBase;
 const navItems=[["cockpit",Compass,"Cockpit"],["profile",UserRound,"Gegevens"],["home",HousePlus,buyer.type==="private"?"Private woning":"Mijn woning"],["documents",UploadCloud,buyer.type==="private"?"Private documenten":"Documenten"],["advice",ShieldAlert,"Adviesprofiel"],["market",BarChart3,"Marktinzicht"],["matches",Home,"Matches"],["coach",Bot,"Assistent"],["share",Share2,"Paspoort"],["agent",Building2,"Makelaar"]].filter(([id])=>hasCurrentHome(buyer)||id!=="home");
